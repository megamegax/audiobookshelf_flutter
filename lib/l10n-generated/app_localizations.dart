...
abstract class AppLocalizations {
  ...
  /// Button label to save the server address
  ///
  /// In en, this message translates to:
  /// **'Save'**
  String get buttonSave;

  /// Button label to login to the server
  ///
  /// In en, this message translates to:
  /// **'Login'**
  ...
  String get labelLoginScreen;

  /// TextField label for the username field
  ///
  /// In en, this message translates to:
  /// **'Username'**
  String get labelUsername;

  /// TextField label for the password field
  ///
  /// In en, this message translates to:
  /// **'Password'**
  String get labelPassword;

  /// Header message on the init screen
  ///
  /// In en, this message translates to:
  /// **'Set Server Address'**
  String get labelSetServerAddress;

  /// TextField label for the server address
  ///
  /// In en, this message translates to:
  /// **'Server Address'**
  String get labelServerAddress;

  /// TextField description for the server address
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Recently Added'**
  String get headerRecentlyAdded;
