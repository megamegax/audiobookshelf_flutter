...
mixin _$Library {
 ...
 String get id; String get name; List<Folder> get folders; int get displayOrder; String get icon; String get mediaType; String? get provider; LibrarySettings get settings;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(folders),displayOrder,icon,mediaType,provider,settings);
...
@useResult
$Res call({
 String id, String name, List<Folder> folders, int displayOrder, String icon, String mediaType, String? provider, LibrarySettings settings
});
...
/// Create a copy of Library
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? folders = null,Object? displayOrder = null,Object? icon = null,Object? mediaType = null,Object? provider = freezed,Object? settings = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  List<Folder> folders,  int displayOrder,  String icon,  String mediaType,  String? provider,  LibrarySettings settings)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Library() when $default != null:
return $default(_that.id,_that.name,_that.folders,_that.displayOrder,_that.icon,_that.mediaType,_that.provider,_that.settings);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<Folder> folders,  int displayOrder,  String icon,  String mediaType,  String? provider,  LibrarySettings settings)  $default,) {final _that = this;
switch (_that) {
case _Library():
return $default(_that.id,_that.name,_that.folders,_that.displayOrder,_that.icon,_that.mediaType,_that.provider,_that.settings);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  List<Folder> folders,  int displayOrder,  String icon,  String mediaType,  String? provider,  LibrarySettings settings)?  $default,) {final _that = this;
switch (_that) {
case _Library() when $default != null:
return $default(_that.id,_that.name,_that.folders,_that.displayOrder,_that.icon,_that.mediaType,_that.provider,_that.settings);case _:
  return null;
...
class _Library implements Library {
  const _Library({required this.id, required this.name, required final  List<Folder> folders, required this.displayOrder, required this.icon, required this.mediaType, this.provider, required this.settings}): _folders = folders;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(_folders),displayOrder,icon,mediaType,provider,settings);
...
/// Create a copy of Library
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? folders = null,Object? displayOrder = null,Object? icon = null,Object? mediaType = null,Object? provider = freezed,Object? settings = null,}) {
