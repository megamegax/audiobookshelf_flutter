...
mixin _$Folder {
 ...
 String get id; String get fullPath; String get libraryId; int get addedAt;
...
@useResult
$Res call({
 String id, String fullPath, String libraryId, int addedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fullPath,  String libraryId,  int addedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Folder() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fullPath,  String libraryId,  int addedAt)  $default,) {final _that = this;
switch (_that) {
case _Folder():
return $default(_that.id,_that.fullPath,_that.libraryId,_that.addedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fullPath,  String libraryId,  int addedAt)?  $default,) {final _that = this;
switch (_that) {
case _Folder() when $default != null:
return $default(_that.id,_that.fullPath,_that.libraryId,_that.addedAt);case _:
  return null;
