...
mixin _$BookChapter {
 ...
 int get id; double get start; double get end; String get title;
...
@useResult
$Res call({
 int id, double start, double end, String title
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  double start,  double end,  String title)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookChapter() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  double start,  double end,  String title)  $default,) {final _that = this;
switch (_that) {
case _BookChapter():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  double start,  double end,  String title)?  $default,) {final _that = this;
switch (_that) {
case _BookChapter() when $default != null:
return $default(_that.id,_that.start,_that.end,_that.title);case _:
  return null;
