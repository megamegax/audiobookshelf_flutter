...
mixin _$MediaProgress {
  ...
  String? get mediaItemType => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      mediaItemId: freezed == mediaItemId
          ...
          : mediaItemId // ignore: cast_nullable_to_non_nullable
              as String?,
      mediaItemType: freezed == mediaItemType
...
/// @nodoc
@JsonSerializable()
class _$MediaProgressImpl
    with DiagnosticableTreeMixin
    implements _MediaProgress {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('libraryItemId', libraryItemId))
      ..add(DiagnosticsProperty('episodeId', episodeId))
      ..add(DiagnosticsProperty('mediaItemId', mediaItemId))
      ...
      ..add(DiagnosticsProperty('ebookLocation', ebookLocation))
      ..add(DiagnosticsProperty('ebookProgress', ebookProgress))
...
abstract class _MediaProgress implements MediaProgress {
  const factory _MediaProgress(
      ...
      final int? lastUpdate,
      final int? startedAt,
      final int? finishedAt}) = _$MediaProgressImpl;
