...
part 'bookshelf_screen.g.dart';

// Search state provider for bookshelf
@riverpod
class BookshelfSearch extends _$BookshelfSearch {
  @override
  String build() => '';
...
class BookshelfScreenState extends ConsumerState<BookshelfScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final ServerSettings? serverSettings = ref.read(serverSettingsProvider);
      ...
      data: (libraryItemsRepository) async {
        ...
        return ResponsiveLayout(
          ...
          appBar: AppBar(
                    ...
                    child: Consumer(
                      builder: (context, ref, child) {
                        return TextField(
                          onChanged: (value) {
                            ref
                                .read(bookshelfSearchProvider.notifier)
                                .updateQuery(value);
                          },
            ...
            actions: const [CompactLibrarySelector(), SizedBox(width: 8)],
          ),
          body: Stack(
            children: [
              Padding(
                  ...
                  builder: (context, ref, child) {
                    ...
                    return ListView(
                      children: libraryItems
                          .where(
                            (book) => book.media.metadata!.title!
                                .toLowerCase()
